...
map<Quadrant, VInc_mpq> get_relu_quadrants_cdd(int K, const vector<double*>& A);

map<Quadrant, VInc_mpq> get_relu_quadrants_cdd_orthant(const int K, const vector<double*>& A,
